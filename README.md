...
Coachbase instance&nbsp;(in process)| `n1ql://host:port@creds=[{"user":"Administrator","pass":"admin123"}]@timeout=10s` | `host:port`
Coachbase cluster&nbsp;(in process)| `n1ql://http://host:port/@creds=[{"user":"Administrator","pass":"admin123"}]@timeout=10s` | `http://host:port/`
